...
erDiagram
    ...
    Order {
        ...
        string order_no "订单号"
        string status "状态: entering/pending_exit/reviewing/topup_pending/rejected/completed"
...
CREATE TABLE orders (
    ...
    status VARCHAR(30) DEFAULT 'entering' COMMENT '状态',
...
### 7. 订单增值服务关联表（order_vas_services）
