...
erDiagram
    ...
    Order {
        ...
        string order_no "订单号"
        string status "状态: entering/partial_exit_pending/pending_exit/reviewing/topup_pending/rejected/completed"
...
### 8. 订单增值服务关联表（order_vas_services）
...
| 时间轴事件 | 增值服务、部分人离场每次独立显示，入场和设备选择事件移除 |
